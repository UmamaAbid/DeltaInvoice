...
<html>
    <head>
        ...
        <title>@if (trim($__env->yieldContent('template_title')))@yield('template_title') | @endif {{ trans('installer_messages.title') }} | v{{ getAppVersion() }}</title>
    ...
    <body>
        <div class="master">
            <div class="box">
                <div class="header">
                    <h1 class="header__title">@yield('title')
                        <br><small>App Version: {{ getAppVersion() }}</small>
                    </h1>
                </div>
                <ul class="step">
