...
@section('css')
<link rel="stylesheet" href="{{ global_asset('custom/libraries/quil-editor/quill.snow.css') }}">
@endsection
...
@section('js')
<script src="{{ asset('custom/js/email/email.js') }}"></script>
<script src="{{ global_asset('custom/libraries/quil-editor/quill.js') }}"></script>
@endsection
