@extends('layouts.app')
														  		...
														  		<tr>
																	...
																	<td>
										            					...
										            					@foreach($filteredData as $parmissionData)
										            							...
										            							@endphp
										            						    <input class="form-check-input {{ $permissionSelect }}" type="checkbox" name="permission[{{ $permissionName }}]" id="{{ $permissionId }}">
        ...
        @section('js')
        <script src="{{ global_asset('custom/js/user/permission/role.js') }}"></script>
        @endsection
