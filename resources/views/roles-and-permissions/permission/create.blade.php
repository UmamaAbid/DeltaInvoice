...
@section('title', __('app.create_permission'))
					...
					<div class="col-12 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <form class="row g-3 needs-validation" id="permissionForm" action="{{ route('permission.store') }}" enctype="multipart/form-data">
                                    {{-- CSRF Protection --}}
                                    @csrf
                                    @method('POST')
        ...
        @section('js')
        <script src="{{ global_asset('custom/js/user/permission/permission.js') }}"></script>
        @endsection
