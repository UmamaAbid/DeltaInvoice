                                    ...
                                    <div class="card-body p-4 row g-3">
                                            ...
                                            <div class="col-md-12 table-responsive">
                                                <table class="table mb-0 table-striped table-bordered" id="itemsTable">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td colspan="4" class="text-center fw-light fst-italic default-row">
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            <td colspan="3" class="fw-bold text-end tfoot-first-td">
                                                                {{ __('app.total') }}
                                                            </td>
...
@section('js')
    <script src="{{ asset('custom/js/items/generate-barcode.js') }}"></script>
