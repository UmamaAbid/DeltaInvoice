@extends('layouts.app')
@section('title', __('item.category.create'))
                    ...
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <form class="row g-3 needs-validation" id="itemCategoryForm" action="{{ route('item.category.store') }}" enctype="multipart/form-data">
                                    {{-- CSRF Protection --}}
                                    @csrf
                                    @method('POST')
...
@section('js')
<script src="{{ asset('custom/js/items/item-category.js') }}"></script>
@endsection
