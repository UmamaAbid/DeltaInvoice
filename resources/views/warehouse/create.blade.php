                    ...
                    <div class="col-12 col-lg-6">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <form class="row g-3 needs-validation" id="warehouseForm" action="{{ route('warehouse.store') }}" enctype="multipart/form-data">
                                    {{-- CSRF Protection --}}
                                    @csrf
                                    @method('POST')
...
@section('js')
<script src="{{ asset('custom/js/warehouse/warehouse.js') }}"></script>
@endsection
