...
@section('title', __('expense.create'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="row">
                    <form class="row g-3 needs-validation" id="expenseForm" action="{{ route('expense.store') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
                                ...
                                <div class="card-body p-4 row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group mb-3">
                                                <x-input type="text" additionalClasses="datepicker" name="expense_date" :required="true" value=""/>
...
@section('js')
<script src="{{ asset('custom/js/expenses/expense.js') }}"></script>
<script src="{{ asset('custom/js/modals/expense-category/expense-category.js') }}"></script>
