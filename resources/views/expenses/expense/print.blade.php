                    ...
                    <div class="card-body">
                        <div class="toolbar hidden-print">
                                <div class="text-end">
                                    ...
                                    @endcan
                                    <button type="button" id="printButton" class="btn btn-secondary"><i class="bx bx-printer mr-1"></i>{{ __('app.print') }}</button>
...
@section('js')
    ...
    <script src="{{ global_asset('custom/js/print/print-and-pdf.js') }}"></script>
@endsection
