                    ...
                    <div class="card-body">
                        <div class="toolbar hidden-print">
                                <div class="text-end">
                                    ...
                                    <a href="{{ route('sale.invoice.print', ['id' => $sale->id]) }}" target="_blank" class="btn btn-outline-secondary px-4"><i class="bx bx-printer mr-1"></i>{{ __("app.print") }}</a>

                                    <a href="{{ route('sale.invoice.pdf', ['id' => $sale->id]) }}" target="_blank" class="btn btn-outline-danger px-4"><i class="bx bxs-file-pdf mr-1"></i>{{ __("app.pdf") }}</a>
                                    ...
                                    <main>
                                        ...
                                        <table id="printInvoice">
                                            ...
                                            <tfoot>
                                                ...
                                                $columnCount = 5 + $totalBatchTrackingRowCount + app('company')['show_discount'] + app('company')['show_mrp'] - (app('company')['tax_type'] == 'no-tax' ? 1 : 0);
