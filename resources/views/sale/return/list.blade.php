...
@endsection
        ...
        <div class="page-wrapper">
            <div class="page-content">
                    ...
                    <div class="card-header px-4 py-3 d-flex justify-content-between">
                        ...
                        <div>
                            <h5 class="mb-0 text-uppercase">{{ __('sale.return.return') }}</h5>
                        </div>

                        @can('sale.return.create')
                        <!-- Button pushed to the right side -->
                        <x-anchor-tag href="{{ route('sale.return.create') }}" text="{{ __('sale.return.return') }}" class="btn btn-primary px-5" />
                        @endcan
                    </div>
                    <div class="card-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <a tabindex="0" class="text-primary" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Filter by Sale Return Date"><i class="fadeIn animated bx bx-info-circle"></i></a>
                        ...
                        <form class="row g-3 needs-validation" id="datatableForm" action="{{ route('sale.return.delete') }}" enctype="multipart/form-data">
                            {{-- CSRF Protection --}}
                            @csrf
                            @method('POST')
                            <input type="hidden" id="base_url" value="{{ url('/') }}">
                            <input type="hidden" id="payment_for" value="sale-return">
        ...
        @include("modals.payment.invoice-payment", ['payment_for' => 'sale-return'])
...
<script src="{{ asset('custom/js/sale/sale-return-list.js') }}"></script>
