...
@section('title', __('app.company'))
                            ...
                            <div class="card-body">
                                ...
                                <div class="fm-menu">
                                    <div class="list-group list-group-flush">
                                        ...
                                        <a href="javascript:;" class="list-group-item py-1 show_module d-none"><i class='bx bx-cube me-2'></i><span>{{ __('app.modules') }}</span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        @endsection
@section('js')
<script src="{{ global_asset('custom/js/company/edit.js') }}"></script>
@endsection
