    ...
    <div class="invoice-container">
        ...
        <table class="table-bordered custom-table table-compact" id="item-table">
            ...
            <tbody>
                ...
                @endforeach
                <tr class="fw-bold">
                    <td class="text-end" colspan="{{ 3 + $totalBatchTrackingRowCount + app('company')['show_mrp'] }}">
                            {{ __('app.total') }}
                    </td>
                    <td class="text-end">
            ...
            <tfoot>
                ...
                @php
                    $noteColumns = 5+ $totalBatchTrackingRowCount + app('company')['show_mrp'] - ((app('company')['tax_type'] =='no-tax') ? 1 : 0) - (app('company')['show_discount'] ? 0 : 1);
                    $noteRosSpan = 4 - ((app('company')['tax_type'] =='no-tax') ? 1 : 0);

                    $amountInWordsRowSpan = 3 + app('company')['show_mrp'] + app('company')['show_party_due_payment'];
                @endphp
                <tr>
