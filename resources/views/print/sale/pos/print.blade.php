...
<head>
    ...
    <link rel="stylesheet" href="{{ global_asset('custom/css/print/pos.css') }}"/>
</head>
<body>
        ...
        <div class="container mt-3">
            ...
            <div class="row">
                ...
                <div class="col-6 text-end">
                    <div>{{ __('sale.invoice') }}: #SL0040</div>
            ...
            <div class="row text-end">
                ...
                <tr>
                    ...
                    @endphp
                    <div class="col-8 text-end"><strong>{{ __('app.total_due_balance') }}</strong></div>
