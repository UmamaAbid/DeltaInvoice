...
@section('title', __('account.balance_sheet'))
    ...
    @section('css')
    <link href="{{ global_asset('assets/plugins/jquery-treegrid/css/jquery.treegrid.css') }}" rel="stylesheet" />
    @endsection
...
@section('js')
    ...
    <script src="{{ asset('custom/js/accounts/balance-sheet-report.js') }}"></script>
    <script src="{{ global_asset('assets/plugins/jquery-treegrid/js/jquery.treegrid.min.js') }}"></script>
