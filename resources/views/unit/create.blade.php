                    ...
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                <form class="row g-3 needs-validation" id="unitForm" action="{{ route('unit.store') }}" enctype="multipart/form-data">
                                    {{-- CSRF Protection --}}
                                    @csrf
                                    @method('POST')
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <x-input type="text" name="short_code" :required="true" value=""/>
                                    </div>
                                    <div class="col-md-6">
...
@section('js')
<script src="{{ asset('custom/js/unit/unit.js') }}"></script>
@endsection
