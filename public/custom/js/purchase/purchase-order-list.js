        ...
        var table = tableId.DataTable({
            ...
            columns: [
                ...
                {data: 'balance', name: 'balance', className: 'text-end'},
                {
                    ...
                    render: function(data, type, full, meta) {
                        if(data == 'Order Open'){
                            return '<div class="badge text-primary bg-light-primary p-2 text-uppercase px-3">'+data+'</div>';
                        }
                        else if(data == 'Order Overdue'){
                            return '<div class="badge bg-light-warning text-warning p-2 text-uppercase px-3">'+data+'</div>';
                        }
                        else if(data == 'Order Completed'){
                            return '<div class="badge bg-light-success text-success p-2 text-uppercase px-3">'+data+'</div>';
                        }else{
                            //Due Date Empty
                            return '<div class="badge text-secondary bg-light-secondary p-2 text-uppercase px-3">'+data+'</div>';
                        }
