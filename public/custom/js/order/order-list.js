    ...
    */
    function loadDatatables(){
        ...
        var table = tableId.DataTable({
            ...
            serverSide: true,
            method:'get',
            ajax: baseURL+'/order/datatable-list',
            columns: [
...

                {
                    ...
                    render: function(data, type, full, meta) {
                        if(data == 'Paid'){
                            return '<div class="badge rounded-pill text-success bg-light-success p-2 text-uppercase px-3">'+data+'</div>';
                        }
                        else if(data == 'Partial'){
                            return '<div class="badge rounded-pill bg-light text-dark p-2 text-uppercase px-3">'+data+'</div>';
                        }else{
                            return '<div class="badge rounded-pill text-danger bg-light-danger p-2 text-uppercase px-3">'+data+'</div>';
                        }
...

                {
                    ...
                    render: function(data, type, full, meta) {
                        ...
                        let className = classMap[data] || classMap['default'];

                        return '<div class="badge rounded-pill text-'+className+' bg-light-'+className+' p-2 text-uppercase px-3">'+data+'</div>';
