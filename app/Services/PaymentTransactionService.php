...
class PaymentTransactionService{
	 ...
	 *
	 * */
	public function recordPayment(Expense|PurchaseOrder|Purchase|PurchaseReturn|SaleOrder|Sale|SaleReturn|CashAdjustment|PartyPayment $modelName, array $data)
    {
     ...
     * @return array
     * */
    public function getPaymentRecordsArray(Expense|PurchaseOrder|Purchase|PurchaseReturn|SaleOrder|Sale|SaleReturn $model): array
    {
     ...
     * Purchase Model
     * */
    public function updateTotalPaidAmountInModel(Expense|PurchaseOrder|Purchase|PurchaseReturn|SaleOrder|Sale|SaleReturn $model) : bool {
